...
public final class TextUtil {
    ...
    final static public String newline_crlf = "\r\n";
    final static public String newline_lf = "\n";

    static public byte[] fromHexString(final CharSequence s) {
    ...
    static public String toHexString(final byte[] buf, int begin, int end) {
        StringBuilder sb = new StringBuilder(3*(end-begin));
        toHexString(sb, buf, begin, end);
        return sb.toString();
    }

    static public void toHexString(StringBuilder sb, final byte[] buf) {
     ...
     */
    static public CharSequence toCaretString(CharSequence s, boolean keepNewline) {
    ...
    static public class HexWatcher implements TextWatcher {
